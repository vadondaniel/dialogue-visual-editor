...
class NormalizationsDialogTests(unittest.TestCase):
    ...
    def test_action_buttons_trigger_bound_callbacks(self) -> None:
        ...
        dialog = NormalizationsDialog(
            ...
            on_smart_quotes=lambda: calls.__setitem__(
                "smart_quotes", calls["smart_quotes"] + 1
            ),
            ...
            count_smart_quotes=lambda: counts["smart_quotes"],
        ...
        self.assertEqual(dialog.smart_quotes_btn.text(), "Smart Quotes... (4)")
        self.assertEqual(
        ...
        self.assertEqual(calls["smart_quotes"], 1)
    ...
    def test_counts_refresh_after_action_runs(self) -> None:
        ...
        self.assertEqual(dialog.smart_quotes_btn.text(), "Smart Quotes... (0)")
        dialog.deleteLater()
    ...
    def test_refresh_counts_uses_safe_zero_when_counting_fails(self) -> None:
        ...
        def _raises_smart_quotes() -> int:
            counts_called["smart_quotes"] += 1
            raise RuntimeError("smart quotes failed")
        ...
        dialog = NormalizationsDialog(
            ...
            count_smart_quotes=_raises_smart_quotes,
        ...
        self.assertEqual(counts_called["smart_quotes"], 1)
